(() => {
    ...
    (() => {
        ...
        function menuOn() {
            ...
            const iconMenuBody = document.querySelector(".menu__body");
            const body = document.querySelector(".body");
            if (iconMenu) iconMenu.addEventListener("click", (() => {
                iconMenu.classList.toggle("menu-open");
                iconMenuBody.classList.toggle("menu-open");
        ...
        if (headerLink) for (var i = 0; i < headerLink.length; i++) headerLink[i].addEventListener("click", (function() {
            var headerLinkActive = document.getElementsByClassName("header__link_active");
            headerLinkActive[0].className = headerLinkActive[0].className.replace(" header__link_active", "");
            this.className += " header__link_active";
        }));
        const colorItemsButton = document.querySelector(".color__button");
        const colorMain = document.querySelector(".color");
        if (colorItemsButton) colorItemsButton.addEventListener("click", (() => {
            colorMain.classList.toggle("_color-main-active");
        }));
        const colorItem = document.querySelectorAll(".color__item");
        if (colorItem) for (i = 0; i < colorItem.length; i++) colorItem[i].addEventListener("click", (function() {
            var colorItemActive = document.getElementsByClassName("_color-active");
            colorItemActive[0].className = colorItemActive[0].className.replace(" _color-active", "");
            this.className += " _color-active";
        }));
        window.onscroll = function() {
            headerScrollFunction();
        };
        const headerScroll = document.querySelector(".header");
        const ofSetHeader = headerScroll.offsetTop;
        function headerScrollFunction() {
            if (window.pageYOffset > ofSetHeader) headerScroll.classList.add("_header-scroll"); else headerScroll.classList.remove("_header-scroll");
        }
        document.addEventListener("mousemove", parallax);
        function parallax(event) {
            this.querySelectorAll(".main__images .main__image").forEach((shift => {
        ...
        function scale(event) {
            this.querySelectorAll(".main__images .main__image img").forEach((shift => {
                const position = shift.getAttribute("value");
                const u = (window.innerWidth + event.pageX + position) / 2500;
                shift.style.transform = `scale(${u})`;
            }));
        }
        new core(".slider-showcase-left", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        new core(".slider-showcase-right", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            var elements = document.querySelectorAll(".item-advantages__number");
            elements.forEach((function(item) {
                ...
                item.updateCounter = function() {
                    ...
                    if (item.counterCount < item.counterTarget) setTimeout(item.updateCounter, item.counterSpeed); else item.innerText = item.counterTarget;
                };
            }));
        ...
        const btnsMain = document.querySelectorAll(".btn");
        ...
        const btn06 = document.querySelector(".btn-06");
        const btn07 = document.querySelector(".btn-07");
        const btn08 = document.querySelector(".btn-08");
        const btn09 = document.querySelector(".btn-09");
        const btn10 = document.querySelector(".btn-10");
        if (btnsMain) {
            btn01.addEventListener("click", (() => {
                btnsMain.forEach((element => {
                    element.classList.add("btn-01");
                    element.classList.remove("btn-02");
                    element.classList.remove("btn-03");
                    element.classList.remove("btn-04");
                    element.classList.remove("btn-05");
                    element.classList.remove("btn-06");
                    element.classList.remove("btn-07");
                    element.classList.remove("btn-08");
                    element.classList.remove("btn-09");
                    element.classList.remove("btn-10");
                }));
            }));
            btn02.addEventListener("click", (() => {
                btnsMain.forEach((element => {
                    element.classList.remove("btn-01");
                    element.classList.add("btn-02");
                    element.classList.remove("btn-03");
                    element.classList.remove("btn-04");
                    element.classList.remove("btn-05");
                    element.classList.remove("btn-06");
